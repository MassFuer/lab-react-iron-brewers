...
function AddBeerPage({ handleAddBeer }) {
  ...
  const [tagline, setTagline] = useState("d");
  const [description, setDescription] = useState("d");
  const [imageUrl, setImageUrl] = useState("d");
  const [firstBrewed, setFirstBrewed] = useState("d");
  const [brewersTips, setBrewersTips] = useState("d");
  const [attenuationLevel, setAttenuationLevel] = useState(0);
  const [contributedBy, setContributedBy] = useState("d");
